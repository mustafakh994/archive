...
namespace FormsManagementApi.Migrations
{
    ...
    [Migration("20250918084936_AddComprehensiveSeedData")]
            ...
            modelBuilder.Entity("FormsManagementApi.Models.AuditLog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Action = "CREATE_FORM",
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 9, 3, 8, 49, 34, 574, DateTimeKind.Unspecified).AddTicks(6149), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            Action = "CREATE_FORM",
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 9, 6, 8, 49, 34, 574, DateTimeKind.Unspecified).AddTicks(6149), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            Action = "SUBMIT_FORM",
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 9, 15, 8, 49, 34, 574, DateTimeKind.Unspecified).AddTicks(6149), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("FormsManagementApi.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "HR",
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 9, 18, 8, 49, 34, 574, DateTimeKind.Unspecified).AddTicks(6149), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Human Resources Department",
                            Name = "Human Resources",
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 9, 18, 8, 49, 34, 574, DateTimeKind.Unspecified).AddTicks(6149), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
            ...
            modelBuilder.Entity("FormsManagementApi.Models.FormPermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 9, 18, 8, 49, 35, 338, DateTimeKind.Utc).AddTicks(9805),
                            FormId = new Guid("60000000-0000-0000-0000-000000000001"),
                            Permission = "admin",
                            UpdatedAt = new DateTime(2025, 9, 18, 8, 49, 35, 338, DateTimeKind.Utc).AddTicks(9806),
                            UserId = new Guid("50000000-0000-0000-0000-000000000001")
                        },
                        new
                        {
                            Id = new Guid("b0000000-0000-0000-0000-000000000002"),
                            CreatedAt = new DateTime(2025, 9, 18, 8, 49, 35, 338, DateTimeKind.Utc).AddTicks(9814),
                            FormId = new Guid("60000000-0000-0000-0000-000000000002"),
                            Permission = "admin",
                            UpdatedAt = new DateTime(2025, 9, 18, 8, 49, 35, 338, DateTimeKind.Utc).AddTicks(9815),
                            UserId = new Guid("50000000-0000-0000-0000-000000000002")
                        },
                        new
                        {
                            Id = new Guid("b0000000-0000-0000-0000-000000000003"),
                            CreatedAt = new DateTime(2025, 9, 18, 8, 49, 35, 338, DateTimeKind.Utc).AddTicks(9819),
                            FormId = new Guid("60000000-0000-0000-0000-000000000003"),
                            Permission = "admin",
                            UpdatedAt = new DateTime(2025, 9, 18, 8, 49, 35, 338, DateTimeKind.Utc).AddTicks(9820),
                            UserId = new Guid("50000000-0000-0000-0000-000000000003")
                        });
                });
            ...
            modelBuilder.Entity("FormsManagementApi.Models.FormSubmission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SubmittedAt = new DateTimeOffset(new DateTime(2025, 9, 8, 8, 49, 34, 574, DateTimeKind.Unspecified).AddTicks(6149), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            SubmittedAt = new DateTimeOffset(new DateTime(2025, 9, 13, 8, 49, 34, 574, DateTimeKind.Unspecified).AddTicks(6149), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            SubmittedAt = new DateTimeOffset(new DateTime(2025, 9, 15, 8, 49, 34, 574, DateTimeKind.Unspecified).AddTicks(6149), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("FormsManagementApi.Models.SuperAdminUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$3gkHZKIy05AgYwCDulMMVeloDpoYJs8LHBdlrWGaG3uXpvTR6xMdm"
                        });
                });
            ...
            modelBuilder.Entity("FormsManagementApi.Models.UsageMetric", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RecordedAt = new DateTimeOffset(new DateTime(2025, 9, 17, 8, 49, 34, 574, DateTimeKind.Unspecified).AddTicks(6149), new TimeSpan(0, 0, 0, 0, 0)),
                            Value = 25
                        },
                        new
                        {
            ...
            modelBuilder.Entity("FormsManagementApi.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            Name = "John Smith",
                            PasswordHash = "$2a$11$eIaXVoVRGVWEaldQRqfajuUvS4BBy7XIUpMutvXXaNSZhMUodzJmm",
                            RoleId = new Guid("30000000-0000-0000-0000-000000000001"),
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 9, 18, 8, 49, 34, 574, DateTimeKind.Unspecified).AddTicks(6149), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            Name = "Sarah Johnson",
                            PasswordHash = "$2a$11$J9lmo7VCdSDYasaiEVs1/upDYp3ffdhmNweZdZlextCUfRI5.kPni",
                            RoleId = new Guid("30000000-0000-0000-0000-000000000002"),
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 9, 18, 8, 49, 34, 574, DateTimeKind.Unspecified).AddTicks(6149), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            Name = "Mike Davis",
                            PasswordHash = "$2a$11$I4AuH1lDebsEfnzMl6stjehQ4IamtBWpy5F/o0HYGR45gLYsPwSXK",
                            RoleId = new Guid("30000000-0000-0000-0000-000000000003"),
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 9, 18, 8, 49, 34, 574, DateTimeKind.Unspecified).AddTicks(6149), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
